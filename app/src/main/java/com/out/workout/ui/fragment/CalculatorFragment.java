...
import com.out.workout.ui.activity.BmiCalculatorActivtiy;
...
public class CalculatorFragment extends Fragment {
    ...
    private void initActions() {
        ...
        workOutModels.add(workOutModel);
        RvCalculator.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false));
    ...
    private void setCalculator(int pos) {
        switch (pos) {
            case 0:
                ...
                return;
            case 1:
                GoIntent(BmiCalculatorActivtiy.class);
                return;
            case 2:
