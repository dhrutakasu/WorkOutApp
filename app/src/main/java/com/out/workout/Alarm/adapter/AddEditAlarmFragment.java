package com.out.workout.Alarm.adapter;
...
import com.out.workout.Alarm.service.AlarmReceiver;
import com.out.workout.Alarm.service.LoadAlarmsService;
import com.out.workout.Alarm.util.ViewUtils;
...
public final class AddEditAlarmFragment extends Fragment {
    ...
    private void save() {
        ...
        final int rowsUpdated = new ExerciseHelper(getContext()).updateAlarm(alarm);
    ...
    private void delete() {
        ...
        builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                final int rowsDeleted = new ExerciseHelper(getContext()).deleteAlarm(alarm);
                int messageId;
                if(rowsDeleted == 1) {
